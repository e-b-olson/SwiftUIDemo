...
# This script generates a @ViewBuilder for all the SwiftUI views
...
def main():
    ...
    create_view_builder(list_of_views)
...
def create_view_builder(list_of_views):
    # args
    template_case_string = "{{ case }}"
    template_file_path = "./templates/view_builder_template.txt"
    output_file_path = "./products/view_builder.txt"
