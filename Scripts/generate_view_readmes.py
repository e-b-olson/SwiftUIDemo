...
def main():
    ...
    for view_name in list_of_views:
        ...
        create_view_readme_file(view_name)
...
def create_view_readme_file(view_name):
    # args
    template_view_name = "{{ view_name }}"
    template_file_path = "./templates/view_readme_template.swift"
    output_file_path = "./SwiftUIDemo/Views/" + view_name + "/" + "README.md"
